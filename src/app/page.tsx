...
import { Sparkles, ArrowRight, Loader2, Lock, Mail, User, Eye, EyeOff } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.error) {
        ...
        // Po udanym zalogowaniu wymuszamy przeładowanie strony.
        // Middleware automatycznie przechwyci to zapytanie i przekieruje
        // użytkownika na poprawny panel (/admin, /teacher, /client)
      ...
      <header className="p-6 max-w-7xl w-full mx-auto flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Platforma Edukacyjna</p>
          </div>
        </div>
        <ThemeToggle />
      </header>
